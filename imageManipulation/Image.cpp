...
//rule of three functions - destructor, copy constructor, copy assignment
//operator 

//destructor - instance member function invoked automatically whenever 
//object is going to be destroyed 
  //LAST FUNCTION THAT IS GOING TO BE CALLED 
...
//copy constructor - called when object of the class type is passed by
//value and when object is initalized by copying another object 
//during declaration
//copy constructor makes a new copy of all data members - deep copy
  //copy constructor can be called with a single pass-by-reference
  //argument of the class type representing an orginial object to be 
...
//copy constructor
Image::Image(const Image& objToCopy)
{
  image = nullptr;
  ...
  allocateImage(objToCopy.width, objToCopy.height);
  for(unsigned int i = 0; i < width; ++i)
  {
    for(unsigned int j = 0; j < height; ++j)
    {
      image[i][j] = objToCopy.image[i][j];
    }
  }
